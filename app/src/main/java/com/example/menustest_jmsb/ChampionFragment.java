...
import com.example.menustest_jmsb.databinding.FragmentChampionBinding;


public class ChampionFragment extends Fragment {

    FragmentChampionBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inicializamos el binding inflando el layout
        binding = FragmentChampionBinding.inflate(inflater, container, false);
